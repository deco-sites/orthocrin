    ...
    <div className="overflow-hidden">
      ...
      <div class="px-[25px] py-[45px]" style={border}>
        ...
        <div class="relative max-w-max">
          <div
            style={style}
            class="flex flex-col flex-wrap rounded-t-[10px] rounded-b-[10px]"
          >
            <p class="flex justify-center mb-[10px] text-[Max(1.65vh,.825rem)]">
          ...
          <img
            class="absolute right-[-79px] bottom-[24px]"
